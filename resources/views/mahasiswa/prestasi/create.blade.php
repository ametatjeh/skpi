...
<style>
    ...
    .upload-icon { width: 56px; height: 56px; margin: 0 auto 12px; background: linear-gradient(135deg, #fef3c7, #fde68a); border-radius: 14px; display: flex; align-items: center; justify-content: center; font-size: 24px; color: #f59e0b; }
    ...
    .info-box { background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-radius: 12px; padding: 18px 20px; margin-top: 24px; border: 1px solid #fbbf24; }
    .info-box-title { font-size: 14px; font-weight: 700; color: #92400e; margin-bottom: 10px; display: flex; align-items: center; gap: 8px; }
    .info-box-content { font-size: 13px; color: #78350f; line-height: 1.6; }
...
<div class="form-page">
    <a href="{{ route('mahasiswa.prestasi.list') }}" class="form-back-btn">
    ...
    <div class="form-header">
        <div class="form-header-content">
            ...
            <div class="form-header-text">
                ...
                <p>Lengkapi form berikut untuk menambahkan prestasi Anda</p>
            </div>
        </div>
    </div>
    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <h3>Form Input Prestasi</h3>
        </div>

        <form action="{{ route('mahasiswa.prestasi.store') }}" method="POST" enctype="multipart/form-data" class="form-card-body">
            @csrf

            <div class="form-grid">
                <div class="form-group full-width">
                    <label class="form-label">Judul Prestasi <span class="required">*</span></label>
                    <input type="text" name="judul_prestasi" class="form-control" placeholder="Contoh: Juara 1 Hackathon Nasional" value="{{ old('judul_prestasi') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="penyelenggara" class="form-control" placeholder="Contoh: Kementerian Pendidikan" value="{{ old('penyelenggara') }}" required>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea name="deskripsi" rows="4" class="form-control" placeholder="Jelaskan tentang prestasi ini...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')<span class="form-error">{{ $message }}</span>@enderror
                </div>

                <div class="form-group full-width">
                    <label class="form-label">Upload Bukti Prestasi (Opsional)</label>
