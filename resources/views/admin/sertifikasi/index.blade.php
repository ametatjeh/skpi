...
@section('title', 'Sertifikasi Mahasiswa')
    ...
    <div class="content-wrapper">
        ...
        <div class="header-actions">
            <div class="page-header">
                ...
                <p>
                    Kelola data sertifikasi dan pelatihan mahasiswa
                </p>
            </div>

            <div class="action-group">
                <form action="{{ route('admin.sertifikasi.index') }}" method="GET" class="search-form" style="display: flex; gap: 10px;">
                    <input type="text" name="search" class="search-input"
                        placeholder="Cari nama mahasiswa atau sertifikat..." value="{{ request('search') }}">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    @forelse($sertifikasiList as $i => $item)
                        <tr>
                            ...
                            <td><span class="badge badge-purple">{{ $item->nomor_sertifikat ?? '-' }}</span></td>
                            <td>
                                @if ($item->file_path)
                                    <a href="{{ asset('storage/' . $item->file_path) }}" target="_blank"
                                        class="file-badge has-file">
                            ...
                            <td style="text-align: center;">
                                <div style="display: flex; gap: 5px; justify-content: center;">
                                    <a href="{{ route('admin.sertifikasi.show', $item->id) }}" class="btn btn-info btn-sm"
                                        title="Detail">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <form action="{{ route('admin.sertifikasi.destroy', $item->id) }}" method="POST"
        ...
        {{-- ✅ PAGINATION - PAKAI $sertifikasiList --}}
        @if ($sertifikasiList->count() > 0)
            <div
                ...
                Menampilkan: <strong>{{ $sertifikasiList->count() }}</strong> data sertifikasi
                @if (request('search'))
