...
@section('title', 'Menunggu Verifikasi Prodi')
@section('page_title', 'Verifikasi Prodi')
@section('page_icon', 'clock')

@section('content')

    <style>
        /* ========================================
           VERIFIKASI PRODI - TEMA HIJAU
           ======================================== */
    ...
    <div class="content-wrapper">
        ...
        <div class="breadcrumb-nav">
            ...
            <span class="separator">›</span>
            <span class="current">Menunggu Prodi</span>
        </div>
        ...
        <div class="header-actions">
            <div class="page-header">
                ...
                <p>
                    Daftar kegiatan mahasiswa yang menunggu verifikasi dari Prodi
                </p>
            </div>

            <div class="action-group">
                {{-- SEARCH --}}
                <form action="{{ route('admin.verifikasi.prodi') }}" method="GET" style="display: flex; gap: 10px;">
        ...
        <div class="filter-tabs">
            <a href="{{ route('admin.verifikasi.prodi') }}" class="filter-tab {{ !request('kategori') ? 'active' : '' }}">
                <i class="fas fa-list"></i> Semua
            </a>
            <a href="{{ route('admin.verifikasi.prodi', ['kategori' => 'Prestasi']) }}"
                class="filter-tab {{ request('kategori') == 'Prestasi' ? 'active' : '' }}">
                <i class="fas fa-trophy"></i> Prestasi
            </a>
            <a href="{{ route('admin.verifikasi.prodi', ['kategori' => 'SertifikasiKompetensi']) }}"
                class="filter-tab {{ request('kategori') == 'SertifikasiKompetensi' ? 'active' : '' }}">
                <i class="fas fa-certificate"></i> Sertifikasi
            </a>
            <a href="{{ route('admin.verifikasi.prodi', ['kategori' => 'Organisasi']) }}"
                class="filter-tab {{ request('kategori') == 'Organisasi' ? 'active' : '' }}">
                <i class="fas fa-users"></i> Organisasi
            </a>
            <a href="{{ route('admin.verifikasi.prodi', ['kategori' => 'PengabdianMasyarakat']) }}"
        ...
        <div class="table-container">
                                ...
                                <td style="text-align: center;">
                                    <div style="display: flex; gap: 5px; justify-content: center; flex-wrap: wrap;">
                                        ...
                                        <button onclick="openRevisionModal({{ $item->id }})"
                                            class="btn btn-warning btn-sm" title="Minta Revisi">
            ...
            @if ($verifikasiList->count() > 0)
                <div
                    ...
                    @if (request('kategori'))
                        dari kategori <strong>{{ class_basename(request('kategori')) }}</strong>
                    @endif
                </div>
            @endif
        </div>
        ...
        <div class="modal-content">
            ...
            <form id="approveForm" method="POST">
                ...
                <button type="submit" class="btn btn-success" style="width: 100%;">
                    <i class="fas fa-check"></i> Approve & Teruskan ke Fakultas
                </button>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form id="rejectForm" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="catatan" class="form-control" placeholder="Jelaskan alasan penolakan (minimal 10 karakter)..."
                        required></textarea>
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="revisionForm" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="catatan" class="form-control" placeholder="Jelaskan apa yang perlu direvisi (minimal 10 karakter)..."
                        required></textarea>
                </div>
