...
<head>
    ...
    <title>Login Fakultas - SKPI UNIDA</title>
    ...
    <div style="position: absolute; bottom: -150px; right: -50px; width: 500px; height: 500px; background: #8b5cf6; border-radius: 50%; filter: blur(150px); opacity: 0.3; z-index: -1;"></div>
        ...
        <div class="form-side">
            <div class="login-header" style="text-align: center;">
                <i class="fa-solid fa-university" style="font-size: clamp(2.5rem, 8vh, 4rem); color: #ffffff; margin-bottom: clamp(5px, 2vh, 15px);"></i>
                <h2 style="justify-content: center;">Login Fakultas</h2>
                <p>Masuk ke sistem SKPI sebagai admin fakultas.</p>
                <br>
            </div>
            ...
            <form method="POST" action="{{ route('fakultas.login.submit') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}"
                        placeholder="fakultas@unida-aceh.ac.id" required autofocus>
                </div>
