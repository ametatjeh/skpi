...
@section('content')
    <div class="page-header">
        <h1><i class="fas fa-user-plus" style="margin-right:10px"></i> Tambah Dekan</h1>
    </div>
    <div class="form-card">
        <div class="form-card-header">
            <div class="form-card-header-icon"><i class="fas fa-user-tie"></i></div>
            <h3>Data Dekan Baru</h3>
        </div>
        <form method="POST" action="{{ route('fakultas.dekan.store') }}">
            @csrf
