...
@section('title', 'Dashboard Fakultas SKPI')
@section('page_title', 'Dashboard Fakultas')
@section('page_icon', 'chart-pie')

@push('styles')
<style>
    /* ============ DASHBOARD FAKULTAS PREMIUM - PURPLE THEME ============ */
    ...
    .stat-card.purple .stat-icon { background: linear-gradient(135deg, #f3e8ff 0%, #ede9fe 100%); color: #7c3aed; }
    .stat-card.green .stat-icon { background: linear-gradient(135deg, #dcfce7 0%, #d1fae5 100%); color: #10b981; }
    ...
    .modern-table {
        width: 100%;
        min-width: 650px; /* Ensures horizontal scroll on mobile */
    ...
    .quick-action-icon.purple { background: linear-gradient(135deg, #7c3aed 0%, #8b5cf6 100%); color: #fff; }
    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-header-left">
                ...
                <div>
                    <h1>Selamat Datang, {{ auth()->user()->name ?? 'Operator Fakultas' }}!</h1>
                    <p>Pantau progres & rekap status SKPI seluruh prodi dari panel ini.</p>
                </div>
            </div>
    ...
    <div class="stats-grid">
        <div class="stat-card green">
            ...
            <div class="stat-content">
                <div class="stat-label">SKPI Final Dikeluarkan</div>
                <div class="stat-value">{{ $jumlahFinalFakultas ?? 0 }}</div>
                <div class="stat-change up">
                    <i class="fas fa-arrow-up"></i>
                    {{ $persenFinalFakultas ?? 0 }}% tahun ini
                </div>
            </div>
        </div>
        ...
        <div class="stat-card purple">
            ...
            <div class="stat-content">
                <div class="stat-label">Draft Menunggu Verifikasi</div>
                <div class="stat-value">{{ $jumlahDraftMenunggu ?? 0 }}</div>
        ...
        <div class="stat-card yellow">
            ...
            <div class="stat-content">
                <div class="stat-label">Draft Dikembalikan/Revisi</div>
                <div class="stat-value">{{ $jumlahDraftRevisi ?? 0 }}</div>
                <div class="stat-change down">
                    <i class="fas fa-exclamation-triangle"></i>
                    Butuh perbaikan prodi
                </div>
            </div>
        </div>
        ...
        <div class="stat-card blue">
            ...
            <div class="stat-content">
                <div class="stat-label">Prodi Aktif</div>
                <div class="stat-value">{{ $jumlahProdiAktif ?? 0 }}</div>
                <div class="stat-change neutral">
                    <i class="fas fa-chart-line"></i>
                    Dengan pengajuan berjalan
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-grid">
        ...
        <div class="dashboard-card">
            <div class="card-header">
                ...
                <a href="{{ route('fakultas.verifikasi.index') }}" class="card-header-badge">
            ...
            <div class="card-body">
                <div class="table-wrapper">
                    ...
                    <tbody>
                        @forelse($rekapPengajuanBaru ?? [] as $draft)
                            <tr>
                                <td>
                                ...
                                <td>
                                    ...
                                    @elseif($draft->status == 'valid_fakultas')
                                ...
                                <td>
                                    <a href="{{ route('fakultas.verifikasi.show', $draft->id) }}" class="btn-view">
                            ...
                            <tr>
                                <td colspan="4">
                                    <div class="empty-state">
                                        ...
                                        <p>Pengajuan SKPI dari prodi akan muncul di sini</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
        ...
        <div class="dashboard-card">
            ...
            <div class="card-body">
                <div class="quick-actions">
                    <a href="{{ route('fakultas.verifikasi.index') }}" class="quick-action-btn">
                    ...
                    <a href="{{ route('fakultas.arsip.index') }}" class="quick-action-btn">
                        <div class="quick-action-icon green">
                            <i class="fas fa-archive"></i>
                        </div>
                        <div class="quick-action-text">
                            <h4>Lihat Arsip SKPI</h4>
                            <p>Rekap SKPI yang sudah final</p>
                        </div>
                    </a>
                    
                    <a href="{{ route('fakultas.laporan.index') }}" class="quick-action-btn">
                        <div class="quick-action-icon blue">
                            <i class="fas fa-chart-bar"></i>
                        </div>
                        <div class="quick-action-text">
                            <h4>Laporan & Statistik</h4>
                            <p>Analisis data SKPI fakultas</p>
                        </div>
                    </a>
                </div>
            </div>
