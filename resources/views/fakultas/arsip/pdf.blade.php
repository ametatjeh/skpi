    ...
    <table class="table-form4">
        <tr>
            ...
            <td class="gray-bg">
                ...
                <div class="value-bg">{{ $arsip->mahasiswa->tanggal_lulus ?? '-' }}</div>
            </td>
        </tr>
        <tr>
            <td>
                <span class="label-cell">TEMPAT DAN TANGGAL LAHIR</span> <span class="en-label">/ Place and Date of
                    Birth</span><br>
        ...
        <tr class="gray-bg">
            <td>
                <span class="label-cell">NOMOR INDUK MAHASISWA</span> <span class="en-label">/ Student Identification
                    Number</span><br>
    ...
    <table class="table-form4">
        <tr class="gray-bg">
            <td>
                ...
                <div class="value-bg">{{ $arsip->sk_pt ?? '-' }}</div>
            </td>
            <td>
                <span class="label-cell">PERSYARATAN PENERIMAAN</span><br>
                <span class="en-label">Entry Requirements</span><br>
                <div class="value-bg">{{ $arsip->persyaratan_penerimaan ?? '-' }}</div>
            </td>
        </tr>
        <tr>
            <td>
                <span class="label-cell">NAMA PERGURUAN TINGGI</span> <span class="en-label">/ Name of
                    Institution</span><br>
                <div class="value-bg">Universitas Muhammadiyah Parepare</div>
            </td>
            <td>
                <span class="label-cell">BAHASA PENGANTAR KULIAH</span><br>
                <span class="en-label">Language of Instruction</span><br>
                <div class="value-bg">Indonesia</div>
            </td>
        </tr>
        <tr class="gray-bg">
            <td>
                ...
                <div class="value-bg">{{ $arsip->akreditasi_pt ?? '-' }}</div>
            </td>
            <td>
                <span class="label-cell">SISTEM PENILAIAN</span><br>
                <span class="en-label">Grading System</span><br>
                <div class="value-bg">{{ $arsip->skor ?? 'Skala 1–4; A=4, B=3, C=2, D=1' }}</div>
            </td>
        </tr>
        <tr>
            <td>
                <span class="label-cell">NOMOR SK AKREDITASI PERGURUAN TINGGI</span><br>
                <span class="en-label">Institution Accreditation’s License Number</span><br>
                <div class="value-bg">{{ $arsip->sk_akreditasi_pt ?? '-' }}</div>
            </td>
            <td>
                <span class="label-cell">LAMA STUDI REGULER</span><br>
                <span class="en-label">Regular Length of Study</span><br>
                <div class="value-bg">{{ $arsip->lama_studi ?? '-' }}</div>
            </td>
        </tr>
    </table>
